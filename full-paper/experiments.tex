...
\begin{figure*}[t]
	...
	\begin{subfigure}{0.33\linewidth}
		...
		\label{fig:multi_agg}
	\end{subfigure}
	\caption{Baseline performance and Effect of Parallel Query Execution \srm{I am not a fan of the gray backgrounds here; use white.  Also us more contrasty colors and ensure it prints OK in black and white.  Finally, lines in line plots should be thicker.  }}
	\label{fig:bank_perf}
\end{figure*}
