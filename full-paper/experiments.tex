...
\begin{figure*}[t]
	...
	\end{subfigure}
	\vspace{-10pt}
	\caption{Effect of Combining Multiple Queries \srm{Also number of groups shouldn't be out of 1e20...}}
	\label{fig:bank_perf}
	\vspace{-10pt}
\end{figure*}
...
We see that for the row-store, latency does improve (and then get worse) as the
...
that it is the number of distinct groups that matters most.
Beyond 4 attributes, the performance degrades drastically.  
