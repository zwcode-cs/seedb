...
\VizRecDB.
%
% \stitle{Metrics.} The primary metrics we focus on in this evaluation 
% are {\em latency}, 
% i.e., how long does \VizRecDB take to return the top $k$
% views, and {\em accuracy}, i.e., whether \VizRecDB
...
% (a) a row-store DBMS vs.~a column-store DBMS
% (b) the individual optimizations detailed in Section~\ref{sec:optimizations},
% such as sharing of computation and parallel execution
% (c) 
%
%
