...
\reviewer {
  D3.1 What RDBMSs are used, and especially, what type of engine? How does
the sizes of the datasets compare with the size of the RAM (in Table 1, what
is the size of each datasets in Mb)?
}
