...
b% in a query between 1 and 20 (i.e., we grouped $n_{agg}$ view
...
high levels led to degraded performance.  The optimal number of queries to 
...
memory budget for some groupings. 
