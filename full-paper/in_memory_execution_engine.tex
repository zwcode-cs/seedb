...
Our results in Sections~\ref{sec:custom_execution_engine_expts}
and~\ref{sec:discussion} empirically show that CI and MAB-based pruning 
schemes work well not only for Euclidean distance but also for EMD and other distance functions.
