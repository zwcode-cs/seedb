...
\agp{Change this to argue that we can use the DBMS version in phases
where in each phase we throw away a bunch of views. Reuse content from Section~\ref{sec:hybrid_exectution_engine}}
...
these algorithms work well for our purpose. \mpv{someone needs to review this justification}
