...
\papertext{Algorithm~\ref{algo:custom_exec_engine} shows the outline of our framework.}
...
We can state our claim formally in the following lemma. The proof based on 
...
\techreport{Pseudocode for our pruning scheme can be found in our technical report~\cite{seedb-tr}.}
\papertext{We state the algorithm formally in
