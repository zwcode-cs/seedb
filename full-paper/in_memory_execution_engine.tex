...
\stitle{Guarantees on Consistent Distance Metrics.} 
...
which are aggregated together to form a utility estimate for a given view. \agp{check prev sentence.}
%Furthermore, they assume that data is randomly sampled, which we do not. 
...
results hold for other distance metrics,
such as $\ell_1$, EMD, and  Jenson-Shannon metric.}
