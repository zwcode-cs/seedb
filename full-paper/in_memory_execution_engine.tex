...
Therefore, as described in the architecture overview, at the end of every phase, 
...
\mpv{needs to say in architecture}
...
\vspace{-10pt}
\centerline{
\hbox{\resizebox{5cm}{!}{\includegraphics[trim=0mm 0mm 0mm 0mm, 
...
Our second pruning scheme adopts the Multi-Armed Bandit (MAB)~\cite{bandits, AuerCF02, LaiR85} 
setting to identify top views.
...
In our setting, the arms correspond to our set of potential visualizations and the reward corresponds
...
to find arms with the highest mean reward (Algorithm~\ref{algo:mab_based_pruning}). 
\mpv{some reviewer comment here?}
...
\mpv{put guarantee from this paper?}
