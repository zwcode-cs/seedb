...
evaluate all our pruning strategies on real-world data. In this section, we focus on the results of BANK and DIAB. The results for AIR and AIR10 are similar and not discussed for brevity. 
\techreport{
