...
\subsection{Combining Optimizations}
...
The corresponding data for ROW stores was presented in the evaluation summary of Section \ref{sec:expt_summary}.
...
However, we find one exception to this observation: for small datasets such as BANK, the time taken by the DBMS to process the entire
table is comparable to the time taken to process a partition of the table. 
