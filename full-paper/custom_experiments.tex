...
the top-$k$ boundary having similar utility (and interestingness).
...
incorrectly chosen, the overall utility of the top-$5$ differs only by 0.013 ($\approx$5\% error) 
...
strategies. 
We pay special attention to $k$ = 5 and 10 because empirically these $k$ values are used most commonly.
