...
inefficiencies.
The first type of optimizations, discussed in Section~\ref{sec:sharing-opt}, involve work {\em sharing}, \mpv{grouping sets are the other end of sharing}
...
\agp{consider deleting the rest of this. even the stuff before is not essential, since
we anyway don't use it.}
