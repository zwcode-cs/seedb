...
Redundant views are views that have similar
...
previously computed view stub, removes any views that contain the same
attributes as the selection predicte of the incoming query and sends the view
stubs to the execution engine.
...
Finally, we pick a single view from every cluster.

Details of our pruning algorithm are presented in Appendix \ref{}. 
