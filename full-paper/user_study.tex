...
This process identified 6 interesting and 48 not interesting visualizations.
...
measure worth exploring''). \mpv{check tense}
...
excellent}
\mpv{add points on chart for k=3, 5, 14}
...
\subsection{\SeeDB vs. Manual Visualization Tool}
...
\stitle{Participants}. We recruited 16 participants (5 female, 11
 ...
 \stitle{Datasets}. Our study used the Housing and Movies datasets from 
 ...
 \mpv{something about small size and latency?}
...
but were in fact recommended by \SeeDB {\em and} bookmarked as being interesting.
...
\mpv{remove:? An intriguing observation from two participants was that while they wanted recommendations to support them
...
\agp{moved point 3 to TR. needs a summary.} \mpv{I added a line in previous point. Should we mention separately?}
\techreport{
\begin{figure}
	\centering
...
\agp{moved limitations to TR, needs a summary. Not sure where this should go}
\mpv{Summary for user study?}
\techreport{
