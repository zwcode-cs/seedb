...
push existing relational databases to support a \SeeDB-type workload.
...
In Appendix \ref{sec:incorporating} we discuss how the \SeeDB\ engine could
be made part of a DBMS.
Next we briefly examine the \SeeDB frontend and then describe the execution engines
in detail.
