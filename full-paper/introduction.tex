...
\crc{
	Finally, we note that this work builds upon the high-level ideas for \SeeDB\ as 
	described in~\cite{DBLP:conf/vldb/Parameswaran2013} and ~\cite{DBLP:journals/pvldb/VartakMPP14}.
}
