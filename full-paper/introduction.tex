...
She uses the Census data~\cite{census}\agp{add citation} 
...
\end{example}
\agp{If we don't refer to the table, we should get rid of it.}
...
\mpv{Depending on discussion flow: As noted previously, in addition to our deviation-based metric,
...
for future work.}
\agp{I think important to keep sentence.}
