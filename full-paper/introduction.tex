...
where the analyst generates a large number of candidate queries, and examines each
...
We previously described some of the vision for  \VizRecDB in \cite{DBLP:conf/vldb/Parameswaran2013},
but formalize our notion of ``interestingness'' in this paper and demonstrate that we can build real
systems that efficiently search for the most interesting views.
...
\squishlist
  ...
  implementation-specific optimizations and heuristics to efficiently perform the
