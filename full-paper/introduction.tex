...
types, aesthetic features, and so on.
...
As a first step in this paper, we focus on  a general deviation-based metric that can capture all six dimensions to a limited extent (see Section~\ref{sec:problem_statement}).  However, because contextual information and aesthetics has been addressed in prior visualization, we focus in most of this paper on 
